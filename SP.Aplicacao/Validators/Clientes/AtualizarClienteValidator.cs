...
{
    public class AtualizarClienteValidator : AbstractValidator<AtualizarClienteDto>
    {
        public AtualizarClienteValidator()
        {
            ...
            RuleFor(x => x.StatusFinanceiro)
                .IsInEnum().WithMessage("Status financeiro inválido");
